...
@property (weak, nonatomic) IBOutlet UIView *buttomView; //底部view
...
-(void)setCornerRadiusWithButton:(UIButton *)btn{
...
-(void)setupUI {
    ...
    //顶部view添加三个label
    CGFloat width = 70;
    self.yearLabel = [CTUIFactory creatLabelInFrame:CGRectMake(ScreenWidth/2 - 20 - width, 0,  width, 75) withText:@"" withAlign:NSTextAlignmentCenter withColor:[UIColor whiteColor] withFont:[UIFont systemFontOfSize:25]];
    self.monthLabel = [CTUIFactory creatLabelInFrame:CGRectMake(ScreenWidth/2 - 17, 0, 35 , 75) withText:@"" withAlign:NSTextAlignmentCenter withColor:[UIColor whiteColor] withFont:[UIFont systemFontOfSize:25]];
    self.dayLabel = [CTUIFactory creatLabelInFrame:CGRectMake(ScreenWidth/2 + 17 , 0, 35 , 75) withText:@"" withAlign:NSTextAlignmentCenter withColor:[UIColor whiteColor] withFont:[UIFont systemFontOfSize:25]];
    [self.buttomView addSubview:self.yearLabel];
    [self.buttomView addSubview:self.monthLabel];
    [self.buttomView addSubview:self.dayLabel];
    ...
    [self setCornerRadiusWithButton:self.cancleBtn];
    [self setCornerRadiusWithButton:self.doneBtn];
    ...
    if (locationString.length >= 10) {
        self.yearLabel.text = [locationString substringToIndex:4];
        self.monthLabel.text = [locationString substringWithRange:NSMakeRange(5, 2)];
        self.dayLabel.text = [locationString substringWithRange:NSMakeRange(8, 2)];
    }
...
- (void)yearmonthdayLabel{
    NSString *date = [_startDate stringWithFormat:@"yyyy-MM-dd"];
    if (date.length >= 10) {
        self.yearLabel.text = [date substringToIndex:4];
        self.monthLabel.text = [date substringWithRange:NSMakeRange(5, 2)];
        self.dayLabel.text = [date substringWithRange:NSMakeRange(8, 2)];
    }
}
-(void)yearChange:(NSInteger)row {
    ...
    preRow = row;
    self.yearLabel.text = self.showYearView.text;
}
